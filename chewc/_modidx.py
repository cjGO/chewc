...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'chewc.cross': { 'chewc.cross._make_cross_geno': ('cross.html#_make_cross_geno', 'chewc/cross.py'),
            ...
            'chewc.pipe': { 'chewc.pipe.PredictionResults': ('predict.html#predictionresults', 'chewc/pipe.py'),
                            'chewc.pipe._gblup_core': ('predict.html#_gblup_core', 'chewc/pipe.py'),
                            'chewc.pipe.gblup_multi_trait': ('predict.html#gblup_multi_trait', 'chewc/pipe.py'),
                            'chewc.pipe.gblup_predict': ('predict.html#gblup_predict', 'chewc/pipe.py')},
