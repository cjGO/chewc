...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'chewc.cross': { 'chewc.cross._make_cross_geno': ('cross.html#_make_cross_geno', 'chewc/cross.py'),
            ...
            'chewc.population': { 'chewc.population.Population': ('population.html#population', 'chewc/population.py'),
                                  ...
                                  'chewc.population.calc_a_inverse_matrix_pedigree_jax': ( 'population.html#calc_a_inverse_matrix_pedigree_jax',
                                                                                           'chewc/population.py'),
                                  'chewc.population.calc_a_matrix_pedigree': ( 'population.html#calc_a_matrix_pedigree',
                                                                               'chewc/population.py'),
                                  'chewc.population.calc_g_matrix': ('population.html#calc_g_matrix', 'chewc/population.py'),
                                  'chewc.population.calc_ibd_matrix': ('population.html#calc_ibd_matrix', 'chewc/population.py'),
                                  'chewc.population.calc_relationship_matrices': ( 'population.html#calc_relationship_matrices',
                                                                                   'chewc/population.py'),
                                  ...
                                  'chewc.population.test_quick_haplo_founder_id_range': ( 'population.html#test_quick_haplo_founder_id_range',
                                                                                          'chewc/population.py'),
                                  'chewc.population.test_quick_haplo_ibd_dimensions': ( 'population.html#test_quick_haplo_ibd_dimensions',
                                                                                        'chewc/population.py'),
                                  'chewc.population.test_quick_haplo_ibd_inbred': ( 'population.html#test_quick_haplo_ibd_inbred',
                                                                                    'chewc/population.py'),
                                  'chewc.population.test_quick_haplo_ibd_outbred_diversity': ( 'population.html#test_quick_haplo_ibd_outbred_diversity',
                                                                                               'chewc/population.py')},
